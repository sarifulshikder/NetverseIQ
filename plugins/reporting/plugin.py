"""
NetverseIQ Plugin: Reporting & Dashboards
Registers Report models and API routes.
"""
from fastapi import FastAPI
from reporting.models import register_models
from reporting.routes import get_router
