"""
NetverseIQ Plugin: Reseller Management
Registers Reseller models and API routes.
"""
from fastapi import FastAPI
from reseller.models import register_models
from reseller.routes import get_router
