"""
NetverseIQ Plugin: Payment Management
Registers Payment models and API routes.
"""
from fastapi import FastAPI
from payment.models import register_models
from payment.routes import get_router
